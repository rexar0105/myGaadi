...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full p-4 md:p-8 animate-fade-in">
        <div className="mb-8">
            <h1 className="text-xl md:text-3xl font-bold text-foreground mb-1 flex items-center gap-2">
               <Sparkles className="text-primary"/> myGaadi Assistant
            </h1>
            <p className="text-muted-foreground">
                Your personal AI to help you with vehicle data.
            </p>
        </div>
